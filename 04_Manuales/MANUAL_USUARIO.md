...
> | 🟢 **11/09 (tarde) — `D-27`: `J14` LIBRE, sin cablear; las cuatro cámaras compradas** | El fin de carrera **no se instala en este despliegue**; el firmware sigue leyendo `PB0` como demanda, así que en `J14` no se conecta nada. La configuración de cada cámara es la de `MANUAL_CONFIGURACION_CAMARAS_IA.md`. §6.2 |
