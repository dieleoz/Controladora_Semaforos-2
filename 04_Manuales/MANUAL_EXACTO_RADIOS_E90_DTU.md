...
## 🧰 6. Diagnóstico desde la pantalla, sin instrumentos
...
en vez de estimarla a ojo. Ver `02_LCD/MANUAL_PANTALLA_LCD.md` §5.6.
...
| **`MANUAL_MANDO_4_RELES.md`** | **Mando de 4 relés** — la interfaz que se opera desde el suelo sin ver la pantalla |
