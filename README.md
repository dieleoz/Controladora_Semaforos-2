...
| banco por packs *(68 packs)* | 🔴 | **985/985** — **todos en `PASS`**. Los ultimos en entrar vigilan lo que la V9.0 estrena: `enlace_01_transporte` (pines, velocidad, buffer y framing del puerto por el que habla el ESP32, que hasta N-94 no miraba nadie), `camara_02_j16`, los nueve del ESP32 y `costura_11_lcd_sin_bus`. |
| compila Maestro / Esclavo / Repetidor / ESP32 | ✅ | **89.3 %** · 66.1 % · 20,6 % · 35,7 % — *7.004 B libres en el Maestro tras las Fases 1 y 2, `AiBus` y N-90* |
...
> ### 📦 El banco son 68 packs — la migración terminó el 05/08, y creció con V9.0
>
