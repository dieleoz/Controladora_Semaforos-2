...
| **A-15** | 🔴 **CADA CUÁNTO siembra el ESP32 la hora a su STM32.** El responsable decidió el 07/09 que la siembra periódica **SÍ se construye** y que la cadencia va **«en horas, días o meses, no cada ms»** — falta **el número** | alta — **sin él la siembra no se puede escribir** | 🟢 **Mi propuesta, y el motivo no es la deriva: UNA HORA, reusando `INTERVALO_SYNC_MS`**, que ya es una hora para el reenvío Maestro→Esclavo. **Un solo número en el sistema en vez de dos**: dos cadencias distintas para la misma hora es lo que nadie recuerda mantener. ⚠️ **Y lo que la cadencia NO arregla, medido: en Degradado NO SE SIEMBRA NADA** —no hay radio, que por eso se entró, ni teléfono—, así que las dos puntas corren libres **hasta 48 h** sobre el HSI. Eso lo decide `A-16`, no esto |
