...
def _diario_suelto(rama, decisores):
    ...
    que ella decidio -que la hora no entro porque esa punta ya tenia hora-."""
...
def correr(b, fw):
    ...
    # -la hora no entro porque esa punta ya tenia hora, y eso es lo que dice-. Se acepta por el
...
"""
    ...
    con_guarda = ('{ if (%s()) { %s("ESP32", "HORA_ESP32_IGNORADA_YA_EN_HORA"); } '
