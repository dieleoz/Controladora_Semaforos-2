...
// --- Cámaras IA AcuSense (Entradas Digitales de Contacto Seco N/O) ---
#define CAM_DEMANDA_PIN    PB0  // Cámara 1 (Maestro) / Cámara 3 (Esclavo) -> Demanda de cola
#define CAM_UMBRAL_PIN     PB8  // Cámara 2 (Maestro) / Cámara 4 (Esclavo) -> Umbral de tramo
...
#define RS485_IN_DE_RE  PA8  // Fijo en HIGH para alta impedancia (Hi-Z) de U3
