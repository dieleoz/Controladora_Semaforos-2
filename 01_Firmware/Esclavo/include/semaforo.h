...
// ---------------------------------------------------------------------------
// SFTY-21 — Senales visibles desde el suelo. Portado del Maestro.
//
...
// darse con las luces.
//
// En el Esclavo el argumento es todavia mas fuerte que en el Maestro: aqui la
// pantalla solo diagnostica, nunca decide el ciclo, asi que las luces no son "otra"
// realimentacion, son la unica que importa.
//
// Se da en DESTELLOS ROJOS CONTABLES, y no en los tres colores, por seguridad y no
// por estetica: el rojo nunca significa "pase", asi que si el operario cuenta mal el
// peor caso sigue siendo seguro. Destellar verde para confirmar algo seria darle a un
// conductor lejano un permiso que nadie le dio.
//
...
// logica. El Modo Degradado, el backstop de verde maximo y la atencion de la radio
// siguen corriendo y actualizando su estado con normalidad; simplemente sus salidas
// se guardan en vez de escribirse, y al terminar la senal se vuelcan de golpe.
//
// Se hizo asi tras descartar lo obvio -ignorar las llamadas durante la senal-, que
// tenia un fallo grave: si alguien pide la transicion a verde y se le ignora, se
// queda esperando para siempre un semaforo_estado()==S_VERDE que nunca llega, con
