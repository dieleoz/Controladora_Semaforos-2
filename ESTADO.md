...
**1180/1180 en 76 packs**. Maestro **87,6 %** (`57416` B), Esclavo **63,7 %** (`41772` B),
...
| Banco por packs | **1180/1180 comprobaciones** en **76 packs** — con **`app_11` en `FALLA`**: el límite de 15 s de `modo_inteligente.cpp:123` por debajo del mínimo vial de 3 min (`D-5`). Hallazgo abierto, no regresión |
