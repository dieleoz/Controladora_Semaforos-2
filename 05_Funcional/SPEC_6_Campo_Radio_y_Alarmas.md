...
| `FALLO_RF` | `REINTENTOS_AGOTADOS` | `CAMBIO_A_AMBAR` | **solo Maestro** | se agotaron los reintentos de un cambio de luz. ⚠️ **Remedido el 13/09: la salida de la espera del acuse de VERDE NO comprueba el enlace** —la del acuse de ROJO si—, asi que esta causa tambien sale con la radio MUERTA, y sale **antes** que la de silencio | **lo normal es que el enlace EXISTA y se degrade** —lluvia, distancia, interferencia—: eso es **cobertura y antena** (B.5), no configuracion. 🔴 **Pero si despues sale tambien `SILENCIO_<n>ms`, el enlace estaba CORTADO y entre las dos alarmas hubo un tramo con la otra punta pudiendo seguir en verde** (SPEC 2 §9). **No se vaya sin mirar la otra punta** |
