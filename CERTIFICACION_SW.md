...
| Banco por packs | **1058/1058 comprobaciones**, **74 packs** | `banco/correr.py` |
...
> hace el C++. Un `1058/1058` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
