...
|---|---|---|
| Compilación Maestro (STM32F103) | **58048 B de Flash — 88.6 %** de 65536 B (quedan **7488 B**) | `pio run` |
| Compilación Esclavo (STM32F103) | **45152 B de Flash — 68.9 %** de 65536 B | `pio run` |
...
| Banco por packs | 🔴 **1243/1246 comprobaciones**, **78 packs** — 77 PASS, **1 FALLA**. **Este documento se FIRMA, así que la frase que había aquí —*«D-14, D-20, D-21, D-22 y D-23 integradas y ancladas»*— se retira por FALSA:** sólo `D-20` y la pieza **B** de `D-21` están construidas. `D-14`, `D-22` y `D-23` son decisiones **vigentes sin construir**, y el rojo las está contando bien | `banco/correr.py` |
...
> |---|---|---|
> | ~~Maestro: 42.620 B (65,0 %)~~ | **58048 B (88.6 %)** | 🔴 **El error grave.** Quien planificase con el 65 % creería tener **~23 KB libres**; quedan **7488 B**. Con esa cifra se propone estructura que **no cabe** |
> | ~~Esclavo: 15.480 B (23,6 %)~~ | **45152 B (68.9 %)** | Casi el triple de ocupación real |
