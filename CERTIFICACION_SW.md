...
| Banco por packs | **1200/1202 comprobaciones**, **77 packs** — las dos que faltan: `D-14` y `D-20`, vigentes y sin ancla en el fuente | `banco/correr.py` |
...
> hace el C++. Un `1200/1202` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
