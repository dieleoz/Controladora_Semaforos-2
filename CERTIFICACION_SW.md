...
| Banco por packs | **1077/1077 comprobaciones**, **75 packs** | `banco/correr.py` |
...
> hace el C++. Un `1077/1077` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
