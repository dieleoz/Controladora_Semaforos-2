...
| Banco por packs | **1220/1222 comprobaciones**, **77 packs** — las dos que faltan: `D-14` y `D-20`, vigentes y sin ancla en el fuente | `banco/correr.py` |
...
> hace el C++. Un `1220/1222` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
