...
| Banco por packs | **1053/1053 comprobaciones**, **74 packs** | `banco/correr.py` |
...
> hace el C++. Un `1053/1053` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
