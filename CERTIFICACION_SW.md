...
| Banco por packs | **954/955 comprobaciones**, **65 packs** | `banco/correr.py` |
...
> hace el C++. Un `954/955` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
