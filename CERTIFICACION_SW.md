...
| Banco por packs | **955/955 comprobaciones**, **65 packs** | `banco/correr.py` |
...
> hace el C++. Un `955/955` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
