...
| Banco por packs | **1200/1201 comprobaciones**, **77 packs** — la que falta: `D-14`, vigente y sin ancla en el fuente | `banco/correr.py` |
...
> hace el C++. Un `1200/1201` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
