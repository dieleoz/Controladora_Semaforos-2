...
|---|---|---|
| Compilación Maestro (STM32F103) | **58296 B de Flash — 89.0 %** de 65536 B (quedan **7240 B**) | `pio run` |
...
| Banco por packs | **919/922 comprobaciones**, **63 packs** (61 PASS, 2 FALLA) | `banco/correr.py` |
...
| App — ejecutada en DOM | **120/120** | arnés jsdom |
...
> |---|---|---|
> | ~~Maestro: 42.620 B (65,0 %)~~ | **58296 B (89.0 %)** | 🔴 **El error grave.** Quien planificase con el 65 % creería tener **~23 KB libres**; quedan **7656 B**. Con esa cifra se propone estructura que **no cabe** |
...
> hace el C++. Un `919/922` acredita coherencia del modelo, **no** el comportamiento del firmware sobre
